...
/// Defines the typescale for the light theme using [AppTextStyles] —
/// the only text styles used throughout the app's light UI.
///
/// Prefer accessing styles through [BuildContext] extensions:
/// ```dart
/// Text('Hello', style: context.typography.titleLarge);
/// ```
TextTheme buildLightTextTheme() {
  return const TextTheme(
    displayLarge: AppTextStyles.kHeading1,
    displayMedium: AppTextStyles.kHeading1,
    displaySmall: AppTextStyles.kHeading1,
    headlineLarge: AppTextStyles.kHeading1,
    headlineMedium: AppTextStyles.kHeading1,
    headlineSmall: AppTextStyles.kHeading2,
    titleLarge: AppTextStyles.kHeading2,
    titleMedium: AppTextStyles.kHeading3,
    titleSmall: AppTextStyles.kBody,
    bodyLarge: AppTextStyles.kBody,
    bodyMedium: AppTextStyles.kBody,
    bodySmall: AppTextStyles.kBodySmall,
    labelLarge: AppTextStyles.kBody,
    labelMedium: AppTextStyles.kCaption,
    labelSmall: AppTextStyles.kCaption,
  );
}