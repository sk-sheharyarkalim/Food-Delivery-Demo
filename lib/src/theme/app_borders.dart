...
abstract final class AppBorders {
  ...
  /// 16 pt — card border radius (design token).
  static const BorderRadius kRadiusCard = BorderRadius.all(Radius.circular(16));

  /// 100 pt — pill border radius (design token).
  static const BorderRadius kRadiusPill = BorderRadius.all(Radius.circular(100));

  /// 12 pt — input field border radius (design token).
  static const BorderRadius kRadiusInput = BorderRadius.all(Radius.circular(12));
  ...
  static const BorderRadius card = kRadiusCard;

  /// Default input field border radius.
  static const BorderRadius input = kRadiusInput;
